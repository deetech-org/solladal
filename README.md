...
The game's master word dataset is maintained in [`tamilwordbank-v2.md`](file:///D:/pethuraj/solladal/tamilwordbank-v2.md) (1,650+ words across five length categories), from which `data/words.json` is generated by `scripts/build_wordbank.py`.
